...
const ComptableSidebar = ({ activeTab, setTab }) => {
    const { logout } = useAuth();

    const menuItems = [
        { id: 'dashboard', label: 'Statistiques', icon: <LayoutDashboard size={20} /> },
        { id: 'validate', label: 'À normaliser', icon: <FileCheck size={20} /> },
        { id: 'history', label: 'Historique Global', icon: <History size={20} /> },
    ];
...
export default ComptableSidebar;
