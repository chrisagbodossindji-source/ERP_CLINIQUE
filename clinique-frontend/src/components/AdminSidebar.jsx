import { LayoutDashboard, Users, UserRound, Activity, ShieldCheck, LogOut } from 'lucide-react';
...
const AdminSidebar = ({ activeTab, setTab }) => {
    ...
    const menuItems = [
        { id: 'general', label: 'Général', icon: <LayoutDashboard size={20} /> },
        { id: 'users', label: 'Utilisateurs', icon: <Users size={20} /> },
        { id: 'patients', label: 'Patients', icon: <UserRound size={20} /> },
        { id: 'logs', label: 'Logs d\'activité', icon: <Activity size={20} /> },
        { id: 'roles', label: 'Rôles & Permissions', icon: <ShieldCheck size={20} /> },
    ];
