import { LayoutDashboard, ClipboardPlus, Users, LogOut } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const InfirmierSidebar = ({ activeTab, setTab }) => {
    const { logout } = useAuth();

    const menuItems = [
        { id: 'dashboard', label: 'Vue générale', icon: <LayoutDashboard size={20} /> },
        { id: 'consultations', label: 'Consultations', icon: <ClipboardPlus size={20} /> },
        { id: 'patients', label: 'Recherche Patient', icon: <Users size={20} /> },
    ];
...
export default InfirmierSidebar;
